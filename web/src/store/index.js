    ...
    productsList : [
      {
        type : "企业ERP管理系统",
        name : "农机报废管理系统",
        introduction : "该模板适用于商家类管理后台，布局方式采用左侧固定，右侧自适应方式，适合大量数据展示和界面操作22121212",
        document : "### 1. 项目背景\n" +
      ...
      },
      {
        type : "企业ERP管理系统",
        name : "报废车管家",
        introduction : "该模板适用于商家类管理后台，布局方式采用左侧固定，右侧自适应方式，适合大量数据展示和界面操作 ",
        document : "### 1. 项目背景\n" +
            "报废车行业是一个十分特殊的行业，目前普遍没有任何规范化的管理标准，加上大多数规模偏小，信息化程度低，如何提升企业附加值，提升企业经济效益，降低管理成本，一直是个十分困难的问题。\n" +
            "国内报废车企业实行资质管理，虽然资质已经完全放开，但准入门槛越来越高，特别是行业主管部门、环保部门、车辆管理部门都有一些特殊的监管要求，需要填报的信息非常多，企业需要投入大量的人力物力才能完成，造成企业管理成本居高不下。\n" +
            "根据《报废机动车回收管理办法》（2019国务院第715号令）以及最新的《报废机动车回收拆解企业技术规范》，《中华人民共和国固体废物污染环境防治法 》等法律法规要求，报废机动车回收拆解企业需要对报废车总成件、回用件以及危废物需要进行溯源管理和流向追踪，信息化管理已经成为必备的硬件条件；\n" +
      ...
      },
      {
        type : "企业ERP管理系统",
        name : "财务管理系统",
        introduction : "212121233443该模板适用于商家类管理后台，布局方式采用左侧固定，右侧自适应方式，适合大量数据展示和界面操作 ",
    ...
    solutionList : [
      {
        ...
        tips : "报废车行业是一个十分特殊的行业，目前普遍没有任何规范化的管理标准，加上大多数规模偏小，信息化程度低，如何提升企业附加值，提升企业经济效益，降低管理成本，一直是个十分困难的问题。 \n" +
            "我们针对不同的企业需求，推出的三种解决方案...",
        title : "报废车机动车行业信息化方案",
      ...
      },
      {
        ...
        tips : "面向众多行业中大型、集团公司企业不同管理系统形成的信息孤岛，与财务系统不能完全集成，或原有的信息化系统虽然包含财务系统但难以做到财务和业务系统的信息集成，依托我公司标准化的财务系统和接口系统，建立数据发现和映射机制，使财务系统中的“凭证探测器”能够实时自动搜索业务系统形成的各种表单（如销售单、采购单、借款还款、费用报销等等）。根据企业具体核算方式和核算内容，制定业务适配规则。基于松耦合紧集成原则，形成完整的业务逻辑信息闭环，自动创建会计凭证。同时，遵循完整性原则和收入与成本匹配原则，很多复杂的问题，可得以轻松解决。业务人员不需要处理任何与财务相关的问题，只需熟悉自己的业务，即可熟练使用信息化系统，极大降低了信息化系统的使用难度，简捷高效。传统那种ERP信息化系统的使用，“上了贼船”的负担，将不复存在。",
        title : "财务与业务信息化集成方案",
        content:"# 财务业务一体化解决方案\n" +
            "## 一体化策略\n" +
